...
class EditQuizPage extends StatefulWidget {
  ...
  EditQuizPage({required this.quizId, required this.currentTitle, required this.currentDesc, required this.currentImage});
              ...
              onPressed: () {
                ...
                DatabaseService(uid: widget.quizId).updateQuizData(
                  widget.quizId,
                  {
                    ...
                    'quizImgUrl': _imageUrlController.text, // Include imageUrl in the update data
                  },
                );
                Navigator.pop(context);
              },
